...
message(STATUS "serial: 2 messages, 0 services")

set(MSG_I_FLAGS "-Iserial:/home/ubuntu/zky_robot/src/serial/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ubuntu/zky_robot/src/serial/msg/wheelPulse.msg" NAME_WE)
add_custom_target(_serial_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "serial" "/home/ubuntu/zky_robot/src/serial/msg/wheelPulse.msg" ""
)

get_filename_component(_filename "/home/ubuntu/zky_robot/src/serial/msg/wheelSpeed.msg" NAME_WE)
add_custom_target(_serial_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "serial" "/home/ubuntu/zky_robot/src/serial/msg/wheelSpeed.msg" ""
)
